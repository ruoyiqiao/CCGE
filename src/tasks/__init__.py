...
from .allegro_cube_in_box import XArmAllegroHandCubeInBox
from .inhand_manipulation_allegro import InhandManipulationAllegro
from .allegro_table_top import XArmAllegroHandTableTop
from .leap_singulation import XArmLeapHandFunctionalManipulationUnderarm, LeapFunctionalManipulationUnderarm
from .leap_cube_in_box import XArmLeapHandCubeInBox, XArm7LeapHandCubeInBox
from .leap_table_top import XArmLeapHandTableTop
from .inhand_manipulation_leap import InhandManipulationLeap
from .leap_bimanual import LeapBimanualManipulationArti
from .leap_bimanual_board_lift import LeapBimanualBoardLift
from .push_2d_task import PushBox2D
...
isaacgym_task_map["XArmLeapHandFunctionalManipulationUnderarm"] = XArmLeapHandFunctionalManipulationUnderarm
isaacgym_task_map["LeapFunctionalManipulationUnderarm"] = LeapFunctionalManipulationUnderarm
isaacgym_task_map["XArmAllegroHandCubeInBox"] = XArmAllegroHandCubeInBox
isaacgym_task_map["XArmLeapHandCubeInBox"] = XArmLeapHandCubeInBox
isaacgym_task_map["InhandManipulationAllegro"] = InhandManipulationAllegro
isaacgym_task_map["XArmAllegroHandTableTop"] = XArmAllegroHandTableTop
isaacgym_task_map["XArmLeapHandTableTop"] = XArmLeapHandTableTop
isaacgym_task_map["InhandManipulationLeap"] = InhandManipulationLeap

isaacgym_task_map["LeapBimanualArti"] = LeapBimanualManipulationArti
isaacgym_task_map["LeapBimanualBoardLift"] = LeapBimanualBoardLift

isaacgym_task_map["PushBox2DPoint"] = PushBox2D

isaacgym_task_map["XArm7LeapHandFunctionalManipulationUnderarm"] = LeapFunctionalManipulationUnderarm
isaacgym_task_map["XArm7LeapHandCubeInBox"] = XArm7LeapHandCubeInBox
